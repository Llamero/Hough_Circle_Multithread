...
public class Hough_Circle implements PlugInFilter {
    ...
    private boolean reduce; //Cap the transform resolution by removeing redundant steps
    ...
    private void startTransform(){
        ...
        for(int slice = 1; slice <= imp.getStackSize(); slice++){
            ...
            if(showCircles || showRadius || showScores) getCenterPoints(nCircles);
    ...
    private void drawCircles(int slice, ImageStack circleStack) {
            ...
            //circlespixels[i] = 0;
            //}
            if(centerPoint == null) getCenterPoints(nCircles);
